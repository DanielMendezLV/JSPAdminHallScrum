        ...
        <div class="panel panel-default"> 
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">                
                    ...
                    <li role="presentation" class ="active"><a href="Redirect.do?go=6">Meta</a></li>
					            ...
					            <div class="panel panel-default">
					                ...
					                <div class="panel-body">
					                    <ul class="list-unstyled" >
					                    	<c:forEach var="meta" items="${listaMeta}">				
						                        <li>
						                            <span > Descripcion ${meta.getDescripcion()}</span>
						                            <span > Fase ${meta.getFase()}</span>
						                            <span > Estado ${meta.isEstado()}</span>
						                            <small><a style="color:blue" href="#" >Detalles</a></small>
