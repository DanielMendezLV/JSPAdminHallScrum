        ...
        <div class="panel panel-default"> 
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">                
                    ...
                    <li role="presentation" class="active"><a href="Redirect.do?go=8">Mensaje</a></li></ul>
                <div class="tab-content">
                		<div role="tabpanel" class="tab-pane active" id="Mensaje">
					            ...
					            <div class="panel panel-default">
					                ...
					                <div class="panel-body">
					                    <ul class="list-unstyled" >
					                        ...
					                        <li>
					                           	Mensaje: <span>${mensaje.getTexto() }</span>
					                            Equipo: <span>${mensaje.getEquipo()}</span> -  Fecha: <span>${mensaje.getFecha() }</span>
