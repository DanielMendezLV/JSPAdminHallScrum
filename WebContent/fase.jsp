        ...
        <div class="panel panel-default"> 
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">                
                    ...
                    <li role="presentation" class="active"><a href="Redirect.do?go=5">Fase</a></li>
                ...
                <div class="tab-content">
       				<div role="tabpanel" class="tab-pane active" id="fase">
                       	<div class="panel-heading">
                            <h2 class="panel-title">Fase</h2>
                        </div>
					            ...
					            <div class="panel panel-default">
					                ...
					                <div class="panel-body">
					                    <ul class="list-unstyled" >
					                   		<c:forEach var="fase" items="${listadoFase}">				
					                    	    <li>
					                    	        <span>${fase.getIdfase() }</span> <span >${fase.getNombre()}</span> del <span>${fase.getFechainicio() } </span> al <span> ${ fase.getFechafinalizacion()}</span>
					                    	        
           	        								<small data-toggle="modal" data-target="#detalleEquipo${fase.getIdfase() }">
														<a style="color:blue"  href="#" > Detalles </a>
													</small>
													<!-- Modal -->
													<div class="modal fade" id="detalleEquipo${fase.getIdfase() }" tabindex="-1" role="dialog" aria-labelledby="detalleEquipo${fase.getIdfase() }Label">
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																		...
																		<c:forEach var="detFase" items="${fase.getListaMetas()}">																		
																			<li><small>${detFase.getDescripcion()}</small>
																			<small>${detFase.isEstado()}</small></li>
																		</c:forEach>
																		</ul>	
																</div>
