        ...
        <div class="panel panel-default"> 
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">                
                    ...
                    <li role="presentation" class="active"><a href="Redirect.do?go=3">Equipo</a></li>
							   ...
							   <div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="list-unstyled" >
											<c:forEach var="equipo" items="${listaEquipo}">
												<li>
													<strong><span>${equipo.getIdEquipo()}</span></strong>: <span >${equipo.getEquipo()}</span>
													<small data-toggle="modal" data-target="#detalleEquipo${equipo.getIdEquipo() }">
													<a style="color:blue"  href="#" > Detalles </a>
													</small>
													<!-- Modal -->
													<div class="modal fade" id="detalleEquipo${equipo.getIdEquipo() }" tabindex="-1" role="dialog" aria-labelledby="detalleEquipo${equipo.getIdEquipo() }Label">
																...
																<div class="modal-body">
																	...
																	<ul>
																		<c:forEach var="detEquipo" items="${equipo.getDetEquipo()}">																		
																			<li><small>${detEquipo.getUsuario()}</small>
																			<small>${detEquipo.getRol()}</small></li>
																		</c:forEach>	
																	</ul>
